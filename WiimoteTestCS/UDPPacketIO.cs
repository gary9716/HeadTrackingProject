  ...
  public class UDPPacketIO
  {
    ...
    public bool Open()
    {
        try
        {
            ...
            Debug.WriteLine("opening udpclient listener on port " + localPort);
        ...
        {
            Debug.WriteLine("cannot open udp client interface at port "+localPort);
            Debug.WriteLine(e);
        }
    ...
    {   
        ...
        Debug.WriteLine("osc message sent to "+remoteHostName+" port "+remotePort+" len="+length);
    }
